...
[![Version](https://img.shields.io/badge/version-0.0.6-blue)](VERSION)
...
The current cross-project release version is stored in [`VERSION`](VERSION) and is `0.0.6`.
...
<DOCKERHUB_USERNAME>/konfigo-backend:0.0.6
<DOCKERHUB_USERNAME>/konfigo-frontend:latest
<DOCKERHUB_USERNAME>/konfigo-frontend:0.0.6
ghcr.io/<OWNER>/konfigo-backend:latest
ghcr.io/<OWNER>/konfigo-backend:0.0.6
ghcr.io/<OWNER>/konfigo-frontend:latest
ghcr.io/<OWNER>/konfigo-frontend:0.0.6
```
